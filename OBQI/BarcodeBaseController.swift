...
class BarcodeBaseController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {

    let session: AVCaptureSession = AVCaptureSession()
    var prevlayer: AVCaptureVideoPreviewLayer!
    var hview: UIView = UIView()
    let appDelegate = (UIApplication.shared.delegate as! AppDelegate)
    var barcodeProtocol:BarcodeProtocol?
    ...
    override func viewDidLoad() {
        ...
        // 子クラスで実装がおこなわれるメソッド群
        barcodeProtocol = self as? BarcodeProtocol
    ...
    func captureOutput(_ captureOutput: AVCaptureOutput!, didOutputMetadataObjects metadataObjects: [Any]!, from connection: AVCaptureConnection!) {
        ...
        // データをセット
        barcodeProtocol?.setDecodedString(decodedString: detectionString)
