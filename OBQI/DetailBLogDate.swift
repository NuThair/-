...
class DetailBLogDate: UIViewController {
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        if InputLabel.text != defaultLabel {
            ansArray = [AppCommon.getDateFormat(date: datePicker.date, format: "yyyy/MM/dd")!]
        }
    ...
    @IBAction func changeDate(_ sender: Any) {
        InputLabel.text = "選択値：\(AppCommon.getDateFormat(date: datePicker.date, format: "yyyy/MM/dd")!)"
    }
}
