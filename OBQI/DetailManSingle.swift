...
class DetailManSingle: OutcomeViewController, UITableViewDelegate, UITableViewDataSource, UIAlertViewDelegate {
    var isNext = false
    ...
    @IBAction func clickNext(_ sender: AnyObject) {
        ...
        if indexPath != nil {
            ...
            SelectArray = [choice as AnyObject]
            ...
            if  AppConst.ManSonotaStrings.contains(choice) {
                isSonotaSelect = true
            }
